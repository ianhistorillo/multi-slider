  ...
  _createClass(MultiSlider, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        const isTouchDevice = () => {
          // Use user agent detection for Surface Pro and Lenovo ThinkPadconst userAgent = navigator.userAgent.toLowerCase();
          // Check if the device is a Microsoft Surface Pro or Lenovo ThinkPad
          const isSurfacePro =
            userAgent.includes("windows nt 10.0") &&
            userAgent.includes("tablet");
          const isLenovoThinkPad =
            userAgent.includes("lenovo") && userAgent.includes("tablet");

          // Force touch events for Surface Pro and Lenovo ThinkPad

          if (isSurfacePro || isLenovoThinkPad) {
            return true; // Force touch events on these devices
          }

          // Otherwise, fallback to the regular touch detection
